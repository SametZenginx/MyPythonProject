...
class Kumanda():
    ...
    def __del__(self):
        ...
        silincek = input("Silmek istediginiz kanali buyuk kucuk harfe uygun yazin: ")
        self.kanalListesi.remove(silincek)
        print("Kanal siliniyor...")
        time.sleep(1)
        print(self.kanalListesi)

    def bluetoothBaglama(self):
        print("Bluetooth'unuzu acin 'W8Q4R' adli cihaza baglanmayi deneyin.")
        time.sleep(3)
        while True:
            baglandiMi = input("Baglandiysaniz 'evet' yazin: ")
            baglandiMi.lower()
            if baglandiMi == "evet":
                print("Kontrol ediliyor..")
                time.sleep(3)
                print("Islem basarili. baglandiniz.")
                break
            elif baglandiMi == "hayir":
...
8. Televizyondan kanal silme

9. Televizyonu bluetooth'a baglama
